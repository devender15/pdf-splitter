...
for pdf in pdfs:
    ...
    shutil.copy(INPUT_DIR + "/" + f"{pdf}", os.path.join(output_dir, "original.pdf"))
...
rprint("-------------------------[bold red]Summary of the output-------------------------")
rprint(f"[dark_olive_green2]Input directory: {INPUT_DIR}[/dark_olive_green2]")
rprint(f"[dark_olive_green2]Output directory: {OUTPUT_DIR}[/dark_olive_green2]")
rprint(f"[dark_olive_green2]Total input PDFs: {len(pdfs)}[/dark_olive_green2]")
rprint(f"[dark_olive_green2]Total PDFs in output: {len(os.listdir(OUTPUT_DIR))}[/dark_olive_green2]")
rprint(f"[dark_olive_green2]Total PDFs generated: {PDF_COUNT}[/dark_olive_green2]")
rprint(f"[dark_olive_green2]Total PDFs failed: {FAILED_PDF_COUNT}[/dark_olive_green2]")